...
async function setCustomPassword() {
  ...
  const newPassword = 'MindVista@Dev2026'; // Your requested password
  ...
  try {
    ...
    console.log(`Password: ${newPassword}`);
    console.log('=' .repeat(50));
    console.log('\n⚠️  NOTE: If the login form has issues with the @ symbol,');
    console.log('    use the direct login page at:');
    console.log('    http://localhost:3000/direct-login');
