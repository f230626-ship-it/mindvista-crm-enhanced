...
/**
 * Set Secure Password (without problematic special characters)
 */
...
async function setSecurePassword() {
  const email = 'mabdullahshafiq100@gmail.com';
  const newPassword = 'MindVista2026Dev'; // Secure but form-friendly password
  ...
  try {
    ...
    console.log('=' .repeat(50));
    console.log('\n💡 This password is secure and form-friendly!');
